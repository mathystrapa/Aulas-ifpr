...
saida = tk.Button(janela_basica, text="fechar janela", command=lambda : janela_basica.quit())   # CRIA UM BOTÃO DE SAÍDA CHAMADO "fechar_janela"

saida.pack(ipadx=55, ipady=55, expand=True)     # EMPACOTA (INSERE) O WIDGET TIPO BOTÃO saida
